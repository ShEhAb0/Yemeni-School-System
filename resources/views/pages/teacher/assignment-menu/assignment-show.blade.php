    ...
    <div class="d-flex  w-100 mt-5">
        ...
        <div class="w-100  mt-5 mb-3 po_re">
            ...
            <div class="d-flex justify-content-between w-100 mt-1 mb-1">
                <h3 class="white">Assignment Title        </h3>
                <span class="white me-9"><i class="fas fa-clock me-2 grey" style="font-size: 15px;"></i><span class="white">DeadLine:  </span><span class="ms-2 text-sm">2020/2/12 12:00 PM</span></span>
            </div>
            <div>
