...
<div class="collapse navbar-collapse  w-auto  max-height-vh-80 h-100 overflowfix" id="sidenav-collapse-main">
    <ul class="navbar-nav">
        <li class="nav-item">
            <a class="nav-link  {{ request()->is('teacher/index') ? 'active' : '' }} "  href="{{route('teacher.index')}}">
        ...
        <li class="nav-item">
            <a class="nav-link {{ request()->is('teacher/lesson') ? 'active' : '' }} "  href="{{url('teacher/lesson')}}">
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
            <a class="nav-link {{ request()->is('teacher/mark') ? 'active' : '' }} "  href="{{url('teacher/mark')}}">
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
            <a class="nav-link {{ request()->is('teacher/assignment') ? 'active' : '' }} "  href="{{url('teacher/assignment')}}">
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
            <a class="nav-link  {{ request()->is('teacher/attendance') ? 'active' : '' }} "  href="{{url('teacher/attendance')}}">
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
            <a class="nav-link {{ request()->is('teacher/news') ? 'active' : '' }} "  href="{{url('teacher/news')}}">
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
