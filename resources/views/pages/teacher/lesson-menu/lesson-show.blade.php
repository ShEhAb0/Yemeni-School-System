                        ...
                        <ul  class="navbar-nav  justify-content-end" style="flex-direction: row;">
                            <li class="nav-item">
                                ...
                                <a class="d-flex d-flex align-items-center  py-1 cursor-pointer"  href="/teacher/profile/{{Auth::user()->id}}">
                                    ...
                                    <div style="margin: auto 0 auto 10;">
                                        <span class="d-sm-inline text-dark text-bold title_Dash">{{ Auth::user()->username}}</span>
...
{{--                                    <a href="../assets/img/kal-visuals-square.jpg" download="filename"><img src="../assets/img/kal-visuals-square.jpg" class="rounded-circle" alt="Cinque Terre" width="100" height="100"></a>--}}
                            ...
                            <div class="d-flex justify-content-around mt-2">
                                @if($lesson->photo)
                                <div>
                                    <a href="{{asset('/Lessons/'.$lesson->subjects->subject_name.'/'.$lesson->photo->url)}}"  download="{{$lesson->photo->url}}"><img src="{{asset('/Lessons/'.$lesson->subjects->subject_name.'/'.$lesson->photo->url)}}" class="fas fa-cloud-download-alt me-2 purplel-color" style="font-size:15px;">
                                    </a>
                                </div>
                                @endif
                            </div>
                        ...
                        <div class="ps-5">
                            ...
                            <div class="d-flex justify-content-around ">
                                ...
                                <div>
                                    @if($lesson->doc)
                                        <div>
                                            <a href="{{asset('/Lessons/'.$lesson->subjects->subject_name.'/'.$lesson->doc->url)}}" download="{{$lesson->doc->url}}">
                                                <i class="fas fa-cloud-download-alt me-2 purplel-color" style="font-size:15px;">
                                                </i> <span class="black">{{$lesson->doc->url}}</span>
                                            </a>
                                        </div>
                                    @endif
...
<script>
    $(document).ready(function(){
        axios({
            method:'get',
            url:'/teacher/notifications/create'
        })
            .then(response =>{
