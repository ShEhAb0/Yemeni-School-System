                ...
                <div class="card-body px-0 pt-0 pb-2">
                            ...
                            @foreach($schedules as $schedule)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <img src="{{asset('/images/teacher_schedule/'.$schedule->file_name)}}" class="img-thumbnail" width="200" height="200" alt="{{$schedule->file_name}}">
                                    </td>
                    ...
                    @else
                        <div class="text-center">
                            <p class="h5 text-danger">There are no schedules for you yet..!</p>
                        </div>
                    @endif
                </div>
            </div>
