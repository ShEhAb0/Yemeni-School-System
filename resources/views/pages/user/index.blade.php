                        ...
                        <div class="col-lg-12">
                                ...
                                <div class="list-group mb-1">
                                    <div class="list-group-item">
                                        <div class="d-flex  py-1">
                                            <img src="{{asset('/images/teachersProfiles/'. $a->teacher->image)}}" class="rounded-circle mt-3 mt-sm-3 mt-lg-0 mt-md-0 mt-xl-0" alt="Cinque Terre" width="50" height="50">
                                            <div style="margin: auto 10;" class="ms-sm-2 ms-md-4 ms-lg-2 ms-xl-2 font_dash1"><span class="text-dark text-bold">{{$a->title}}</span>
                                                <br/>
                                                <span  style="font-size: 15px;" class="text-primary font_dash"><i class="fas fa-clock me-2" style="font-size: 14px;"></i>{{date('Y-m-d' , strtotime($a->due_date))}}</span>
                                            </div>
                                            <div style="margin: auto 10;" class="ms-2 ms-sm-6 ms-md-8 ms-lg-3 ms-xl-3 font_dash1"><span class="text-dark text-bold">Tr.{{$a->teacher->teacher_name}}</span>
                                                <br/>
                                            ...
                                            <a  href="/assignment/{{$a->id}}" class="ms-4 mt-3 mt-sm-2 mt-lg-0 mt-md-0 mt-xl-0  ms-sm-6 ms-md-8 ms-lg-5 ms-xl-5" target="_blank" ><i class="fas fa-share-square font_dash2" style="font-size: 48px;"></i></a>
                            ...
                            @else
                                <div class="text-center">
                                    <p class="h5 text-danger">There are no assignments ..!</p>
                                </div>
                            @endif
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="max-height-vh-80  h-80" style="overflow-y: auto;">
                                @if($news->count() > 0 || $student_news->count() > 0 )
                                @foreach($news as $n)
                                ...
                                @endforeach
                                        ...
                                        @foreach($student_news as $sn)
                                            <p class="mb-1 pt-2 text-bold">Published at : {{$sn->created_at}} </p>
                                            <h5 class="font-weight-bolder">News Title: {{$sn->title}}</h5>
                                            <p class="mb-5">{{substr($sn->description ,0 , 1000)}} {{strlen($sn->description) > 1000 ? "..." : ""}}</p>
                                        @endforeach
                                    @else
                                        <div class="text-center">
