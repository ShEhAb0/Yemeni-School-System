...
<div class="collapse navbar-collapse  w-auto  max-height-vh-80 h-100  overflowfixside" id="sidenav-collapse-main">
    <ul class="navbar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link  {{ request()->is('admin/terms') ? 'active' : '' }}" href="{{url('admin/terms')}}">
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    <i class="fas fa-list blue-color-icon" style="font-size: 12px;"></i>
        ...
        <li class="nav-item">
            <a class="nav-link   {{ request()->is('admin/grades') ? 'active' : '' }}" href="{{url('admin/grades')}} ">
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
            <a class="nav-link  {{ request()->is('admin/parents') ? 'active' : '' }}" href="{{url('admin/parents')}}">
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
            <a class="nav-link   {{ request()->is('admin/grade-news') ? 'active' : '' }}" href="{{url('admin/grade-news')}} ">
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    <i class="fas fa-rss-square blue-color-icon" style="font-size: 12px;"></i>
        ...
        <li class="nav-item" >
            <a class="nav-link   {{ request()->is('admin/admins') ? 'active' : '' }}" href="{{url('admin/admins')}}" >
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
            <a class="nav-link   {{ request()->is('admin/tracking') ? 'active' : '' }}" href="{{url('admin/tracking')}}">
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
            <a class="nav-link    {{ request()->is('admin/school/settings') ? 'active' : '' }}" href="{{url('admin/school/settings')}}">
                <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
