    ...
    public function create()
    {
        ...
        if ($count > 0){
            foreach ($notifications as $notification){
                $note .= '
                <li class="mb-2">
                            <a class="dropdown-item border-radius-md" href="/admin/notifications/'.$notification->id.'">
            ...
            $note .= '<hr><div class="text-center"><a href="/admin/notifications">Show all</a></div>';
        }else
            $note = '<div class="text-center"><p>No notifications</p></div> <hr><div class="text-center"><a href="/admin/notifications">Show all</a></div>';
